<template>
  <div class="main-content container mt-4">
    <div style="display: flex; justify-content: space-between">
      ...
      <router-link to="/admin/application/apps/add">
        <button class="btn btn-primary mb-3" @click="create">Create App</button>
      </router-link>
    </div>
    <table class="table table-hover align-middle shadow-sm">
      ...
      <tbody>
        <tr v-for="(app, index) in applications" :key="index">
          ...
          <td>
            <span class="material-icons"> {{ app.icon.toLowerCase() }}</span>
          </td>
        ...
        <tr v-if="!applications || (applications && !applications.length)">
...
export default {
  ...
  methods: {
    ...mapActions("Application", ["fetchApplications", "deleteApplication"]),
  },
  components: {
    BaseAction,
  },
